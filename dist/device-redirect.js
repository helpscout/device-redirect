(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["DeviceRedirect"] = factory();
	else
		root["DeviceRedirect"] = factory();
})(this, function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MobileDetect = __webpack_require__(1);
	...
	var DeviceRedirect = function () {
	  ...
	  _createClass(DeviceRedirect, [{
	    ...
	    value: function openApp() {
	      ...
	      var rule = this.rules[this.detect.os()];
	      if (!rule) {
	        return;
	      }

	      if (this.root.document) {
	        var iframe = this.root.document.createElement('iframe');
	      ...
	      if (this.shouldRedirect()) {
	        this.timeout = setTimeout(function () {
	          _this.redirect(rule.redirectUrl);
	        }, MOBILE_TIMEOUT);
	      }
